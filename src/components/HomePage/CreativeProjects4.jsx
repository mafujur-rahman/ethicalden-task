  ...
  return (
    ...
    >
      <div className="max-w-full mx-auto relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          <h2 className="text-xl mb-16">SEP 2024 - CREATIVE</h2>
          <p className="text-6xl font-bold mb-10">Travel <br /> explore</p>
...
export default CreativeProjects4;
